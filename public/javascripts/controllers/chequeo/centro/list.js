(function(){
  ...
  app.controller('listCentro', function($scope, $http, $timeout, $mdDialog, ToastFactoria, $filter){
    var $cCtrl = this;
    $cCtrl.pagina = 0;
    $cCtrl.idEliminar = 0;
    ...
    $cCtrl.ordenar = [1,2,3,4,5,6,7];

    $cCtrl.openModal = function(ev) {
      $mdDialog.show({
    ...
    $cCtrl.listarCentros = function () {
      $cCtrl.loading = true;
      $http.get('/chequeo/centro/listar')
